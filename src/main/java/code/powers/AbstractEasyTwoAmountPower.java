...
public abstract class AbstractEasyTwoAmountPower extends TwoAmountPower {
    public int amount2 = -1;
    public boolean isTwoAmount = true;
    ...
    public AbstractEasyTwoAmountPower(String ID, String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        this.ID = ID;
